...
class Main
{
	public static void main(String[] args)
	{
		...
		array_list_of_strings.remove(1);
		//array_list_of_strings = ["One", "Third"]
		
		System.out.println("array_list_of_strings: " + array_list_of_strings);  
		System.out.println();
		
		num_items = array_list_of_strings.size();
		for(int i = 0; i < num_items; i++)
		{
			System.out.print("array_list_of_strings.get(" + i + "): ");
			System.out.println(array_list_of_strings.get(i));
...
array_list_of_strings: [First, Third]

array_list_of_strings.get(0): First
array_list_of_strings.get(1): Third
*/
