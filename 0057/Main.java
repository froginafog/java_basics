...
public class Main
{
	...
	{	             
		...
		game_object.print_loading_message();
	}
}
...
interface Loading  //"abstract" by default
{
	String default_loading_message = "loading...";
	//it is "static" and "final" by default
	//must be assigned a value
...
class Game implements Message, Loading
{
	String game_name;
	...
	public void print_loading_message()
	{
		System.out.println(game_name + " is " + default_loading_message);
	}
	//This method must be public because it is part of an "interface".
}
